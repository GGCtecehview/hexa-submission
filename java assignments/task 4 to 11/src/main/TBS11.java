...
public class TBS11 {
        ...
        do {
            ...
            switch (choice) {
                ...
                case 6:
                    ...
                    break;
                case 7:
                    getBookingDetails(scanner, bookingDAO, eventDAO);
                    break;
                case 8:
    ...
    private static void getBookingDetails(Scanner scanner, BookinDAOImpl bookingDAO, EventDAOimpl eventDAO) {
        try {
            ...
            if (booking != null) {
                ...
                // Display booking and event details
                ...
                System.out.println("Event Name: " + (event != null ? event.getEventName() : "N/A"));
                System.out.println("Event Type: " + (event != null ? event.getEventType() : "N/A"));
            } else {
